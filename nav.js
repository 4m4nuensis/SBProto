...
.bottom-fixed{
  ...
  width:100%;max-width:440px;background:linear-gradient(0.187deg,var(--bg) 89.121%,rgba(1,12,35,0) 99.246%);
  z-index:50;
}
.bottom-nav{
...
.sln-group{
  ...
  width:100%;max-width:440px;height:48px;bottom:122px;z-index:60;pointer-events:none;
}
.sln-clock{
